    ...
    class NewShopMenuText
    {
        private static void Prefix(ShopaloShop __instance)
        {
            if (MasteryMod.DifficultyIsMastery())
            {
                ...
                __instance.MoveItens[1].Description = "Often it is a good idea to skip boost pads - if you're already going really fast, they can actually slow you down!";
                ...
                __instance.SpecialItens[5].Description = "Remember, things that give you more score give you more multiplier as well. Try to focus just on the things that give you the most score when going for score medals.";
